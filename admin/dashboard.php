...
<div class="wrapper d-flex">
    ...
    <div id="content" class="p-4 p-md-5 pt-5 w-100">
        ...
        <?php if (!empty($message)): ?>
            <!-- This assumes message_box.php exists in views/components/ -->
                                        ...
                                        <?php foreach ($allAssignedTasks as $task): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <!-- Updated onclick call for delete task -->
        ...
        <!-- User Task Reports (Dynamic Data) -->
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="card shadow-sm rounded-3">
        ...
        <!-- Latest Admin Activities / Notifications (Dynamic Data) -->
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="card shadow-sm rounded-3">
