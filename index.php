...
if (isLoggedIn()) {
    ...
    switch ($userRole) {
        case 'admin':
            ...
            $allowedPages['add_expense'] = ADMIN_ADD_EXPENSE_PAGE_PATH;
            $allowedPages['manage_expenses'] = ADMIN_MANAGE_EXPENSES_PAGE_PATH;
            $allowedPages['edit_expense'] = ADMIN_EDIT_EXPENSE_PAGE_PATH;
...
<div class="wrapper d-flex">
    <!-- Moved custom-menu outside sidebar -->
    ...
    <!-- Removed Bootstrap padding classes from #content here -->
